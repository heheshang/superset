...
const netRevenueDailyDoDToolTip = 'Net Revenue As of Date Current-Previous Date';
const netRevenueDailyYoY = '0.90x';
const netRevenueDailyYoYToolTip = 'Net Revenue As of Date Current-Previous Year';
...
const netRevenueQuarterlyQoQToolTip = 'Net Revenue QTD  Current-Previous Quarter';
...
const shopperVisitsDailyDoDToolTip = 'Shopper Visits As of Date Current-Previous Date';
const shopperVisitsDailyYoY = '0.80x';
const shopperVisitsDailyYoYToolTip = 'Shopper Visits As of Date Current-Previous Year';
const shopperVisitsWeekly = '15.0M';
const shopperVisitsWeeklyWoW = '0.96x';
const shopperVisitsWeeklyWoWToolTip = 'Shopper Visits WTD  Current-Previous Week';
const shopperVisitsWeeklyYoY = '0.90x';
const shopperVisitsWeeklyYoYToolTip = 'Shopper Visits WTD  Current-Previous Year';
const shopperVisitsMonthly = '141.3M';
const shopperVisitsMonthlyMoM = '0.95x';
const shopperVisitsMonthlyMoMToolTip = 'Shopper Visits MTD  Current-Previous Month';
const shopperVisitsMonthlyYoY = '1.08x';
const shopperVisitsMonthlyYoYToolTip = 'Shopper Visits MTD  Current-Previous Year';
const shopperVisitsQuarterly = '141.3M';
const shopperVisitsQuarterlyQoQ = '0.95x';
const shopperVisitsQuarterlyQoQToolTip = 'Shopper Visits QTD  Current-Previous Quarter';
const shopperVisitsQuarterlyYoY = '1.08x';
const shopperVisitsQuarterlyYoYToolTip = 'Shopper Visits QTD  Current-Previous Year';
const shopperVisitsYearly = '923.9M';
const shopperVisitsYearlyYoY = '1.08x';
const shopperVisitsYearlyYoYToolTip = 'Shopper Visits YTD  Current-Previous Year';
...
const conversionQuarterlyQoQToolTip = 'Conversion QTD  Current-Previous Quarter';
...
const cancelAmountDailyDoDToolTip = 'Cancel Amount As of Date Current-Previous Date';
const cancelAmountDailyYoY = '5.7%p';
const cancelAmountDailyYoYToolTip = 'Cancel Amount As of Date Current-Previous Year';
...
const cancelAmountMonthlyMoMToolTip = 'Cancel Amount MTD  Current-Previous Month';
const cancelAmountMonthlyYoY = '2.9%p';
const cancelAmountMonthlyYoYToolTip = 'Cancel Amount MTD  Current-Previous Year';
const cancelAmountQuarterly = '14.8%';
const cancelAmountQuarterlyQoQ = '2.5%p';
const cancelAmountQuarterlyQoQToolTip = 'Cancel Amount QTD  Current-Previous Quarter';
const cancelAmountQuarterlyYoY = '2.9%p';
const cancelAmountQuarterlyYoYToolTip = 'Cancel Amount QTD  Current-Previous Year';
...
const returnAmountDailyDoDToolTip = 'Return Amount As of Date Current-Previous Date';
const returnAmountDailyYoY = '2.0%p';
const returnAmountDailyYoYToolTip = 'Return Amount As of Date Current-Previous Year';
...
const returnAmountMonthlyMoMToolTip = 'Return Amount MTD  Current-Previous Month';
const returnAmountMonthlyYoY = '1.7%p';
const returnAmountMonthlyYoYToolTip = 'Return Amount MTD  Current-Previous Year';
const returnAmountQuarterly = '0.5%';
const returnAmountQuarterlyQoQ = '1.3%p';
const returnAmountQuarterlyQoQToolTip = 'Return Amount QTD  Current-Previous Quarter';
const returnAmountQuarterlyYoY = '1.7%p';
const returnAmountQuarterlyYoYToolTip = 'Return Amount QTD  Current-Previous Year';
