...
SQLALCHEMY_DATABASE_URI = 'postgresql://superset:superset@localhost:15432/superset'
...
SQLALCHEMY_EXAMPLES_URI = "postgresql+psycopg2://superset:superset@localhost:15432/superset"
